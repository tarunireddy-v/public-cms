            ...
            <table style={{ width: '100%' }}>
                ...
                <tbody>
                    {complaints.map(c => {
                        ...
                        const mapsUrl = `https://www.google.com/maps?q=${encodeURIComponent(c.location || '')}`;
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                                                            ...
                                                            <div>
                                                                ...
                                                                <a href={mapsUrl} target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.75rem', color: 'var(--primary)', cursor: 'pointer', textDecoration: 'underline' }}>
                                                                    View on Map
                                                                </a>
                                                            </div>
                                                        </div>
