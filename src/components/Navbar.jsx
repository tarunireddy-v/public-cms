  ...
  return (
    <nav className="navbar" style={{ paddingLeft: '2rem', paddingRight: '2rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flex: 1 }}>
            ...
            <button type="button" className="nav-link" onClick={handleBenefitsClick} style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', textDecoration: 'none', color: 'var(--text-secondary)', font: 'inherit' }}>
                Benefits
            </button>
        </div>
